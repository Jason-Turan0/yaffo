"""Unit tests for the widget tools (yaffo/site_agents/page/tool_providers/widget_tool.py).
...
from yaffo.site_agents.page.tool_providers import widget_tool as wt
