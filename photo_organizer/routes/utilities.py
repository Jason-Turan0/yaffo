...
def _run_sync_job(job_id: str, files_to_index: list, files_to_delete: list):
    ...
    try:
        ...
        for i in range(20):
            ...
            job_tracker.update_job(
                ...
                message=f"Processing... {int(progress)}% complete"
            )
...
def init_utilities_routes(app: Flask):
    ...
    def utilities_sync_photos():
        ...
        thread = threading.Thread(
            ...
            args=(job.id, files_to_index, files_to_delete)
        )
        thread.daemon = True
        thread.start()
