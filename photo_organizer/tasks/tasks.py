...
#from photo_organizer.common import HUEY_DB_PATH #, DB_PATH
# from photo_organizer.logging_config import get_logger


# Create engine at module level (thread-safe and picklable)
# check_same_thread=False is needed for SQLite with threading
...
from photo_organizer.tasks.config import huey
