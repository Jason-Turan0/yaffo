...
def _scripts() -> str:
    return block("scripts", [
        ...
        "To show the user photos, call link_to_photos (the gallery with filters, e.g. a",
        "person and a year) or link_to_media_item (one photo). The app shows the link under",
        "your answer; never write URLs or paths yourself. Look up the ids first (people,",
        "labels, media items) with a script.",
