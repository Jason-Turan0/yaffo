...
export class PromptGenerator {
    ...
    async getSystemPrompt(outputSchema?: string): Promise<string> {
        ...
        const instructionBlocks = [
            ...
            "    5. Before hard-coding seeded database IDs or repeated lookup logic, inspect existing shared helper modules",
            "       under generated_tests/_support/ and import/reuse them.",
            "    6. Prefer helper functions that resolve test data by stable attributes such as filename, visible text,",
